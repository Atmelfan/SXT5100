...
// pompage total, trouvi dans les libs de sdcc
...
char *asctime(struct tm *timeptr) {
  CheckTime(timeptr);
  sprintf (ascTimeBuffer, "%04d-%02d-%02dT%02d:%02d:%02d ", 1900+timeptr->tm_year, 1+timeptr->tm_mon, timeptr->tm_mday, timeptr->tm_hour, timeptr->tm_min, timeptr->tm_sec);
